...
export const metadata: Metadata = {
  title: 'Apartment Setup in East Village & Greenwich Village',
  description: 'Just moved in? Furniture assembly, TV mounting, curtains and shelves in East Village and Greenwich Village. Free photo quote. $69/hour, 2-hour minimum.',
  alternates: { canonical: 'https://handlyr.org/move-in-nyc' },
};
...
const SMS_HREF = `sms:+13477998402?body=${encodeURIComponent(
  'Hi Serge! I need a Manhattan move-in setup quote.\nService needed: \nZIP code: \nPreferred day: \nI will attach a photo of the job.',
)}`;
const RECENT_WORK = GALLERY_ITEMS.filter((project) =>
  ['tv-mounting.webp', 'bed-frame-assembly.webp'].some((file) => project.image.endsWith(`/${file}`)),
);
    ...
    <main className="min-h-[100svh] bg-neutral-50 px-5 py-7 sm:py-10">
      <div className="mx-auto w-full max-w-md">
        ...
        <section className="pt-8" aria-labelledby="quote-heading">
          <p className="text-xs font-semibold uppercase tracking-wider text-primary-700">East Village · Greenwich Village</p>
          <h1 id="quote-heading" className="mt-3 font-heading text-3xl font-extrabold leading-tight tracking-tight text-primary-800 sm:text-4xl">
            Just moved in?<br />Let’s get you settled.
          </h1>
          <p className="mt-3 text-base leading-relaxed text-text-muted">
            Beds and desks assembled. TVs, curtains and shelves installed. Get your apartment set up in one visit — text Serge your list and photos for a free quote.
          </p>
          ...
          <div className="mt-5 border-y border-neutral-200 py-4 text-sm leading-relaxed text-text-muted">
            ...
            <p>Bundle your move-in tasks into one visit. Time needed depends on your list.</p>
            <p className="mt-1 text-xs">Wall installations require your landlord’s permission. Free quotes by photo. On-site assessment: ${PRICING.estimateFee}, credited toward your job.</p>
          </div>
        </section>

        <section className="pt-6" aria-labelledby="work-heading">
          <div className="mb-3 flex items-center justify-between gap-3">
            <h2 id="work-heading" className="font-heading text-base font-bold text-primary-800">From boxes to a home</h2>
