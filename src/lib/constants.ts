...
export const REVIEWS = [
  ...
  },
  {
    id: 4,
    stars: 5,
    text: 'Professional — everything was done in a timely manner.',
    name: 'Judaea H.',
    location: 'New Jersey',
    initials: 'JH',
  },
  {
    id: 5,
    stars: 5,
    text: 'Great guy and works super fast!',
    name: 'Lashay D.',
  ...
  },
  {
    id: 6,
    stars: 5,
    text: 'Serge was great — came in a timely manner, communicated effectively and worked well. I will definitely be asking for him again. 10/10 he did well.',
    name: 'Quasia B.',
    location: 'Brooklyn, NY',
    initials: 'QB',
  },
